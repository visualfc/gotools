...
func Process(filename string, src []byte, opt *Options) ([]byte, error) {
	...
	file, adjust, err := ParseSource(fileSet, filename, src, opt)
	if err != nil {
		return nil, err
	}
...
func ParseSource(fset *token.FileSet, filename string, src []byte, opt *Options) (*ast.File, func(orig, src []byte) []byte, error) {
